...
###############################################################################
IMAGE_DIR = "../imgs/"
#IMAGE_FILE = "rostros.png"
IMAGE_FILE = "rostros_h.png"
...
frame1 = np.zeros((ISHY+4*PADY+TEXT_HEIGHT, ISHX+2*PADX, 3), np.uint8)
...
while (True):
    ...
    cvui.text(frame1, PADX, PADY*2+ISHY, f"Segmentada", 0.5)
    ...
    cvui.image(frame1, PADX, PADY, img_seg)
