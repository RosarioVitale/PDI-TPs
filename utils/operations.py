...
def diferencia(img1, img2, reesc="no", imin=0, imax=255, dtype="uint8"):
    ...
    Parameters:
        ...
        reesc: Metodo de reescalado. Valores: "sum", "res", "no" 
        (por defecto: no). 
            Si es "sum", suma 255 y divide por 2. 
            Si es "res", resta el minimo y escala a 255. 
            Si es "no", limita los valores al rango [imin, imax].
        dtype: Tipo de dato de la imagen resultante ("uint8" por defecto)
    Returns:
        img: Imagen resultante.
    ...
    if reesc == "sum":
        ...
        print("Error: elegir uno de los valores para reescalar: sum, res o no")
        return
